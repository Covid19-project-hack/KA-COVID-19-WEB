$(document).ready(function () {
  ...
  var fc_ref = firebase.database().ref().child("health_care").child("dc");
  fc_ref.on("child_added", (snap) => {
    ...
    <p class="mb-1"><i class="fas fa-hashtag" style="margin-right: 15px;"> </i>    ${type}</p>
    </div>`;
  });
});
